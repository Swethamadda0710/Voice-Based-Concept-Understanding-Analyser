...
from modules.auth import authenticate_user, change_password, create_user
...
from pages.teacher_portal import render_teacher_portal
...
def render_sidebar():
    with st.sidebar:
        ...
        st.caption("STUDENT PORTAL" if st.session_state.role == "student" else "TEACHER PORTAL")
        items = [("⌂", "Dashboard"), ("▣", "My Assignments"), ("◉", "Submit Answer"), ("◍", "My Results"), ("⚙", "Profile")] if st.session_state.role == "student" else [("⌂", "Dashboard"), ("?", "Questions"), ("◌", "Students"), ("▣", "Assignments"), ("◍", "Submissions"), ("▤", "Reports"), ("⚙", "Profile")]
...
if not st.session_state.authenticated:
    render_login(authenticate_user, create_user)
    st.stop()

render_sidebar()
page = st.session_state.active_page
if st.session_state.role == "student":
    render_student_portal(page)
elif st.session_state.role == "teacher":
    render_teacher_portal(page)
else:
    if page == "Home":
        render_home()
